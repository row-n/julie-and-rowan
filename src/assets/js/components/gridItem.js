  ...
  toggle(action) {
    this.DOM.inner.forEach((inner) => {
      ...
      TweenMax.to(inner, speed, {
        ...
        y: action === 'hide' ? this.constructor.name === 'Thumb' ? -1 * Site.winsize.height - 36 : -1 * Site.winsize.height - 36 + inner.offsetHeight / 2 : 0, // eslint-disable-line no-nested-ternary
      });
